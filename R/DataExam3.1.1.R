#' @title    Data for Example 3.1.1 from Experimental Design and Analysis for Tree Improvement
#' @name     DataExam3.1.1
#' @docType  data
#' @keywords datasets
...
#' @usage    data(DataExam3.1.1)
#' @format A \code{data.frame} with 10 rows and 6 variables.
#' \describe{
